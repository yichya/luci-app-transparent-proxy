...
o = s:option(Value, "redirect_port", translate("Redirect Port"), translate("The matched connections will be redirected to this port. There should be a port forwarding service listening on this port with MARK set to 255 (0xff), such as RedSocks, V2Ray (dokodemo-door), Shadowsocks (ss-redir) and so on."))
o.placeholder = 1234
o.default = 1234
o.datatype = "port"
o.rmempty = false
